...
def game_life_simulate(universe, iterations):
    '''
    Simulation of the game over gievn iterations
    
    Parameters
    -------
    universe
        array of initial universe
    iterations
        integer as the number of iterations to be generated

    Returns
    --------
    latest_universe
        array of final universe
    '''
    if iterations == 0:
        return universe
    next_universe = None
    for i in range(0,iterations):
        next_universe = generation(universe)
